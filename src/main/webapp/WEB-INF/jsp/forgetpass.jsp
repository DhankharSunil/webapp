    ...
    <div class="imgcontainer">
 		<div class="container">
 			<h1 style="color: #247998; text-align: center; font-family: proxima-nova; margin-left: -10px;
			    margin-right: auto; margin-bottom: 40px; margin-top: -30px;">Reset Password</h1>
		      <label for="uname"><b>E-mail</b></label>
		      <input type="text" placeholder="Enter E-mail" name="email" required onchange="valEmail(document.form1.email)">
		      <button type="submit" onclick="validateEmail(document.form1.email)">Search</button>
			...
			style="color: white; background: #04AA6D; padding: 12px;margin:0px,10px; border-color: #04AA6D; text-transform: none; "
				value="Register">Login</button></a>
		</span>
		<a href="<%=request.getContextPath()%>/registerpage" style="color: #1b7e9f;margin: 10px" tabindex="7">
		<i class="fa fa-key" aria-hidden="true"> </i>Create an Account</a>
    	</div>
    </div>
    </div>
   </div>
